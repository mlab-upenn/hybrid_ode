...
if __name__ == "__main__":
    ...
    print(f"Base name for data/model: {base_name}")

    train_samples, val_samples, test_samples = load_data(base_name=base_name)
    ...
    results_dir = Path(config['data'].get('output_dir', 'results')) / base_name
